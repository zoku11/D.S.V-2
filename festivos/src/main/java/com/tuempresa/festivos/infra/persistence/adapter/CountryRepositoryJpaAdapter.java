...
public class CountryRepositoryJpaAdapter implements com.tuempresa.festivos.domain.port.repository.CountryRepository {
    ...
    @Override public com.tuempresa.festivos.domain.model.Country save(com.tuempresa.festivos.domain.model.Country c){ 
        CountryEntity e = CountryEntity.fromDomain(c);
        CountryEntity s = repo.save(e);
        return s.toDomain();
    }
    @Override public Optional<com.tuempresa.festivos.domain.model.Country> findById(Long id){
        return repo.findById(id).map(CountryEntity::toDomain);
    }
    @Override public List<com.tuempresa.festivos.domain.model.Country> findAll(){
